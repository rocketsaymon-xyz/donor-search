...
Наиболее сильным фактором является заполнение группы крови (Вероятнее всего группа крови является прокси-показателем вовлечённости пользователя): Conversion Rate составляет 50,4% против 14,9% у пользователей без этой информации (Odds Ratio=5,8). Пользователи с более заполненным профилем значительно чаще становятся донорами.
